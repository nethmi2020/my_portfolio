          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="name" class="form-control" placeholder="enter service name" value="{{old('name',$service->name)}}" required/>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label for="exampleTextarea1">Description</label>
              <textarea class="form-control" id="exampleTextarea1" rows="4" maxlength="255" name="description" required>{{old('description',$service->description)}}</textarea>
            </div>
          </div>
